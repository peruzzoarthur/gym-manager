...
const AuthStopwatchLazyImport = createFileRoute('/_auth/stopwatch')()
...
const AuthStopwatchLazyRoute = AuthStopwatchLazyImport.update({
  path: '/stopwatch',
  getParentRoute: () => AuthRoute,
} as any).lazy(() =>
  import('./routes/_auth/stopwatch.lazy').then((d) => d.Route),
)
